...
// ReSharper disable InconsistentNaming
        public const byte MSG_TYPE_SERVER_IDLE = 0xFF;
        public const byte MSG_TYPE_CLIENT_IDLE = 0x01;
        public const byte MSG_TYPE_CHAR_NEW = 0x39;
        public const byte MSG_TYPE_CHAR_DELETE = 0x3A;
        public const byte MSG_TYPE_COMPRESSED = 0x78;

        public const byte MSG_TYPE_LOGIN_REPORT = 0x02;
        public const byte MSG_TYPE_LOGIN_REPORT_TYPE_BANNED = 0x00;
        public const byte MSG_TYPE_LOGIN_REPORT_TYPE_INUSE = 0x01;
        public const byte MSG_TYPE_LOGIN_REPORT_TYPE_WRONGPASS = 0x02;
        public const byte MSG_TYPE_LOGIN_REPORT_TYPE_OKAY = 0x03;
        public const byte MSG_TYPE_LOGIN_REPORT_TYPE_INVALID = 0x03;

        public const byte MSG_TYPE_CHAR_INFO = 0x03;

        public const byte MSG_TYPE_CHAR_INFO_REQUEST = 0x05;
        public const byte MSG_TYPE_LOGIN_CHAR_SELECT = 0x06;

        public const byte MSG_TYPE_BASE_INFO_REQUEST = 0x09;
        public const byte MSG_TYPE_BASE_LOCATION_ENTER = 0x0E;
        public const byte MSG_TYPE_BASE_LOCATION_EXIT = 0x0F;

        public const byte MSG_TYPE_ENTER_TRADER_SCREEN = 0x18;

        //public const byte MSG_TYPE_LOCATION_ENTER = 0x07;
        public const byte MSG_TYPE_LOCATION_EXIT = 0x08;
        public const byte MSG_TYPE_LOCATION_INFO_REQUEST = 0x09;

        public const byte MSG_TYPE_SET_NEWS = 0x1E;

        public const byte MSG_TYPE_PLAYER_INFO = 0x52;

        public const byte MSG_TYPE_LOGIN_SERVER_STATUS = 0x54;
...
// ReSharper restore InconsistentNaming
        ...
        {
            byte[] accid = Encoding.Unicode.GetBytes(idstr.ToLowerInvariant());
            uint hash = accid.Aggregate<byte, uint>(0, (current, t) => crctbl[(current & 0xFF) ^ t] ^ (current >> 8));
            ...
            uint result = (hash & 0xFF000000) >> 24 | (hash & 0x00FF0000) >> 8 | (hash & 0x0000FF00) << 8 |
                          (hash & 0x000000FF) << 24;
