...
namespace FOS_ng.Objects.Solar
{
    ...
    public class StarSystem
    {
        ...
        public List<FOS_ng.Objects.Solar.Solar> Gates = new List<FOS_ng.Objects.Solar.Solar>();
        public string Nickname;
        public Dictionary<uint, FOS_ng.Objects.Solar.Solar> Solars = new Dictionary<uint, FOS_ng.Objects.Solar.Solar>();
        public uint SystemID;

        public List<Zone> Zones = new List<Zone>();

        public FOS_ng.Objects.Solar.Solar FindGateTo(uint systemid)
        {
        ...
        public FOS_ng.Objects.Solar.Solar FindHoleTo(uint systemid)
        {
            //foreach (Solar s in Gates)
        ...
        public void CalculatePathfinding()
        {
            ...
            foreach (var node1 in _pathfinding)
            {
                foreach (var node2 in _pathfinding)
                {
                    ...
                    var d = (s2.Position - s1.Position).Length();
